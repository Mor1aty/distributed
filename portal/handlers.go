...
func (studentsHandler) renderStudents(w http.ResponseWriter) {
	...
	_ = rootTemplate.Lookup("students.html").Execute(w, s)
}
...
func (studentsHandler) renderStudent(w http.ResponseWriter, id int) {
	...
	_ = rootTemplate.Lookup("student.html").Execute(w, s)
...
func (studentsHandler) renderGrades(w http.ResponseWriter, r *http.Request, id int) {
	...
	if res.StatusCode != http.StatusCreated {
		log.Println("failed to save grade to Grading Service. Statue: ", res.StatusCode)
		return
	}
